...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?=APP_URL;?>/Views/Recursos/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <!-- Theme style -->
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?=APP_URL;?>/Views/Recursos/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?=APP_URL;?>/Views/Recursos/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?=APP_URL;?>/Views/Recursos/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
...
<!-- DataTables -->
<script src="<?=APP_URL;?>/Views/Recursos/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?=APP_URL;?>/Views/Recursos/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
